...
namespace уп
{
    public partial class requestFormMaster : Form
    {
        ...
        {
            InitializeComponent();
            connection = new SqlConnection(@"Server=192.168.188.11;Database=kirkuzup;Integrated Security=true;"); // Строка подключения к БД
        ...
        private void LoadRequests()
        {
            try
            {
                ...
                dataGridView1.Columns[2].HeaderText = "CARid";
                dataGridView1.Columns[3].HeaderText = "Problem";
                dataGridView1.Columns[4].HeaderText = "State";
                dataGridView1.Columns[5].HeaderText = "DataEnd";
                dataGridView1.Columns[6].HeaderText = "FIO";
        ...
        {
            using (SqlConnection conn = new SqlConnection(@"Server=192.168.188.11;Database=kirkuzup;Integrated Security=True"))
            {
                conn.Open();
                string query = @"
