...
namespace уп
{
    ...
    {
        private string connectionString = @"Server=192.168.188.11;Database=kirkuzup;Integrated Security=True";
        ...
        private void LoadRequests()
        {
            ...
            dataGridView1.Columns[5].HeaderText = "Master";
            dataGridView1.Columns[6].HeaderText = "DataEnd";
        }
